...
function _getNode(node, uuid) {
  ...
  return _doRelationshipRequest('GET', node, uuid)
    .then(helpers.parseJsonRes)
    .then(res => {
...
function _setNode(node, uuid) {
  ...
  return _doRelationshipRequest('POST', node, undefined, undefined, undefined, undefined, {uuid: uuid})
    .then(helpers.parseJsonRes)
    .then(res => {
      log.debug({operation, uuid, res: JSON.stringify(res)});
      return res;
...
function _updateNode(node, uuid, data) {
  ...
  return _doRelationshipRequest('PUT', node, uuid, undefined, undefined, undefined, data)
    .then(helpers.parseJsonRes)
    .then(res => {
...
function _getMemberFromNode(node, nodeId, memberType, memberId) {
  ...
  return _doRelationshipRequest("GET", node, nodeId, "member", memberType, memberId)
    .then(helpers.parseJsonRes)
    .then(res => {

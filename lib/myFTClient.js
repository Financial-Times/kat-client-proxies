...
function _getNodesFollowingConceptAsIndividual(licenceId, conceptId, nodeType) {
  ...
  return _createAndTriggerScopedRequest('GET', myftConst.licenceNodeName, licenceId, myftConst.topicNodeName, conceptId, myftConst.followedRelName, nodeType, null, params)
    .then(helpers.parseJsonRes)
    .then(res => {
      log.debug({operation, licenceId, conceptId, nodeType, res: 'success'});
      return res;

...
function _getNodesFollowingConceptByKat (licenceId, conceptId, nodeType, params) {
  ...
  return _createAndTriggerScopedRequestByKat('GET', myftConst.licenceNodeName, licenceId, myftConst.topicNodeName, conceptId, myftConst.followedRelName, nodeType, null, params)
    .then(helpers.parseJsonRes)
    .then(res => {
      log.debug({operation, licenceId, conceptId, nodeType, res: 'success'});
      return res;
 ...
 * @private
 */
function _createAndTriggerScopedRequestByKat(method, node, nodeId, relatedNode, relatedNodeId, relationship, relatedType, data, params) {

...
function addConceptsFollowedByKatGroupMembSpec(userUUIDs, conceptUUIDs, relationshipProperties, groupUUID) {
  log.silly({operation: 'acfbkgms', groupUUID, userUUIDs: JSON.stringify(userUUIDs), conceptUUIDs: JSON.stringify(conceptUUIDs), relationshipProperties});
...
function removeConceptsFollowedByKatGroupMembers(groupUUID, conceptUUIDs, relationshipProperties) {
    log.debug({operation: '🐱 removeConceptsFollowedByKatGroupMembers',groupUUID, conceptUUIDs, relationshipProperties});
...
function removeConceptsFollowedByKatGroupMembSpec(userUUIDs, conceptUUIDs, relationshipProperties, groupUUID) {
  log.silly({operation: 'rcfbkgms Remove', groupUUID, userUUIDs: JSON.stringify(userUUIDs), conceptUUIDs: JSON.stringify(conceptUUIDs), relationshipProperties});
